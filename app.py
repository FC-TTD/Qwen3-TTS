...
**Note**: This demo uses intelligent memory management to prevent OOM errors.
Only one model is loaded at a time. Models are automatically unloaded when switching.
"""
        )
